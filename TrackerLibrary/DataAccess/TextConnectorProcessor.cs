...
namespace TrackerLibrary.DataAccess.TextHelpers
{
    public static class TextConnectorProcessor
    {
        ...
        {
            // C:\Users\diazr\source\repos\TournamentTracker\PrizeModels.csv
        ...
        public static void SaveToTournamentsFile(this List<TournamentModel> models, string fileName)
        {
            ...
            foreach (TournamentModel model in models)
            {
                lines.Add($"{model.Id}, {model.TournamentName}, {model.EntryFee}," +
                    $"{ConvertTeamsListToString(model.EnteredTeams)}, {ConvertPrizesListToString(model.Prizes)}, {ConvertRoundsListToString(model.Rounds)}");
            }
